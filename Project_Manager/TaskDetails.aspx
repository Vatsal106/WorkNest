<%@ Page Title="" Language="C#" MasterPageFile="~/Project_Manager/P_Manager.Master" AutoEventWireup="true" CodeBehind="TaskDetails.aspx.cs" Inherits="WorkNest.Project_Manager.TaskDetails" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Manager_Header_Title" runat="server">Task Details </asp:Content>

<asp:Content ID="Content4" ContentPlaceHolderID="Manager_Content" runat="server">
        ...
        <div class="card">
            ...
            <div class="text-center" style="margin-bottom: 20px;">
                <asp:Button ID="btnSubmitReport" runat="server" Text="📝 Submit Report"
                    ...
                    OnClick="btnSubmitReport_Click" Visible="false" />
            </div>
        </div>
