<%@ Page Title="" Language="C#" MasterPageFile="~/P_Member/MemberM.Master" AutoEventWireup="true" CodeBehind="StatusOfLeave.aspx.cs" Inherits="WorkNest.P_Member.StatusOfLeave" %>
                ...
                <asp:TemplateField HeaderText="Status">
                    <ItemTemplate>
                        <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("STATUS") %>'
                            CssClass='<%# GetStatusClas(Eval("STATUS").ToString()) %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
